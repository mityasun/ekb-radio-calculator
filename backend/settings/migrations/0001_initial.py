    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='system/', verbose_name='Логотип')),
                ...
                ('google_tag_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Google Tag ID')),
                ('yandex_counter_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Яндекс метрика ID')),
                ('mailru_counter', models.TextField(blank=True, max_length=100, null=True, verbose_name='Mail ru метрика ID')),
                ('privacy_text', models.CharField(max_length=20000, validators=[functools.partial(utils.validators.validate_text, *(), **{'max_length': 20000})], verbose_name='Политика конфиденциальности')),
            ],
            options={
