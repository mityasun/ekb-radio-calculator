...
export const RESULT_CONTENT_TEXT = {
...
export const NUMBER_DIGIT_REGEXP = /\B(?=(\d{3})+(?!\d))/g;

export const toolTipStyle = { maxWidth: '300px', backgroundColor: '#05bb75', color: '#ffffff', zIndex: 9999 };

export const DATA_TOOLTIP_TEXT = 'Выберите хотябы одну дату в месяце';
